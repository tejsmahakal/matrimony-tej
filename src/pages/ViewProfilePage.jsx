...
//           /* FIX → Sidebar visible from md and above */
...
//         <Section title="Recommended grooms for you" data={groomList} />
//         <Section title="Suitable Match in Pune" data={groomList} />
...
//           <h2
//             className="text-[24px] font-semibold text-orange-600"
...
//           <a
//             href="/MatchesInPune"
//             className="text-[18px] text-orange-600 hover:text-orange-700"
//             style={{ fontFamily: "Garamond, serif" }}
//           >
//             View all
//           </a>
...
//           className={`p-1 rounded-full border border-gray-400 hover:bg-gray-100 ${
